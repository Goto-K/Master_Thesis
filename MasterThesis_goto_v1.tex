...
\begin{titlepage}
 \begin{center}
  ...
  \vspace{40pt}
  {\large  後藤\ 輝一 \\[1ex] 指導教員\ 末原\ 大幹 } \\[1em]
  \today\\
 \vspace{100pt}
...
\include{Chapter/2DeepLearning}
\include{Chapter/3Networks}
\include{Chapter/4VertexFinderwithDL}
\include{Chapter/5Comparison}
\include{Chapter/6Conclusion}
\include{Chapter/7Acknowledgement}
\include{Chapter/8Appendix}
