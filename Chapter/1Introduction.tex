...
ILC計画とは、日本の東北にある北上山地に図\ref{2InternationalLinearCollider}のような全長$20.5\ \mathrm{km}$の国際線形加速器 (ILC) を建設する計画である。リニアコライダー
...
$\rm e^+e^- \to Zh$事象はヒッグス粒子の反跳粒子である$\rm Z$粒子の識別をすることによって、ヒッグス粒子の崩壊モードに寄らず事象を選別できるという点で非常に重要である。
